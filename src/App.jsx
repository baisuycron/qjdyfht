...
function ErpActivitySyncButton() {
  const [phase, setPhase] = useState("idle");
  useEffect(() => {
    if (phase === "syncing") {
      const timer = window.setTimeout(() => setPhase("success"), 800);
